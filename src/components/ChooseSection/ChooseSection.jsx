  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why PES College of Engineering?</h2>
                    ...
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                Recognized for excellence, PES College of Engineering has proudly received 2 prestigious trophies in acknowledgment of outstanding achievements in academics and innovation.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                At PES College of Engineering, student satisfaction is our top priority. We strive to create a positive and vibrant learning environment, ensuring the happiness and well-being of our students throughout their academic journey.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                With campuses strategically located in three different regions across the UK, PES College of Engineering offers accessibility and convenience for students seeking a quality education. Explore our campuses and embrace a diverse learning experience.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
